...
* **Interactivité** : AJAX via Fetch API et Architecture "One Page CRUD".
...
* **C1** : Conception & Design Thinking (Figma, UML, Diagramme de classes).
* **C2** : Interface utilisateur (HTML/Tailwind/Alpine.js).
* **C3** : Back-end & BDD (Laravel, Eloquent, MySQL).
* **C4** : Collaboration & DevOps (Git, GitHub Flow, Kanban).
...
* **IDE** : Antigravity (ou VS Code avec extension Continue).
* **Versionning** : Git (Branches `main` et `develop`).
